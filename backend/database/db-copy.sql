...
CREATE TABLE `comment`  (
  ...
  `liked` int(11) NOT NULL DEFAULT 0 COMMENT '被点赞数',
  `createTime` bigint(20) NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_createTime`(`createTime`) USING BTREE
...
CREATE TABLE `coin`  (
  ...
  `description_zh` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '中文描述',
  ...
  `social` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '社交媒体',
  `belong` tinyint(1) NULL DEFAULT null COMMENT '属于什么，0:IEOs,1:STOs,2:ICOs',
  `rating` decimal(10,2) NULL DEFAULT NULL COMMENT '评分',
  `createTime` bigint(20) NOT NULL COMMENT '创建时间',
  ...
  `for_sale` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT 'For Sale',
  ...
  `bounties` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT 'Bounties赏金',
  `distribution` varchar(400) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT 'Distribution令牌分发',
  `isDelete` tinyint(1) DEFAULT 0 COMMENT '是否显示',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_createTime`(`createTime`) USING BTREE
...
CREATE TABLE `stage`  (
  ...
  `start` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '开始时间',
  `end` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '结束时间',
  `bonuses` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '奖金红利',
  `tokens_for_sale` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT 'Tokens for Sale',
