<template>
  ...
  >
    ...
    <md-dialog
      ...
      :md-fullscreen="false">
      <md-dialog-title>修改{{ currentLabel }}</md-dialog-title>
      ...
      <md-dialog-actions>
        <md-button
          class="md-primary"
          @click="showDialog = false">取消</md-button>
        <md-button
          class="md-primary"
          @click="updateUser">确定</md-button>
      </md-dialog-actions>
    </md-dialog>
  </s-layout>
</template>
...
export default {
  ...
  methods: {
    ...
    editDialog (type) {
      ...
      switch (type) {
        case 'nickname': {
          this.currentLabel = '昵称'
          break
        }
        case 'bio': {
          this.currentLabel = '个人介绍'
          break
        }
        case 'avatar': {
          this.currentLabel = '更换头像'
          break
        }
        default: {
          this.currentLabel = '个人介绍'
