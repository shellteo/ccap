  ...
  <div class="smb-comment">
    ...
    <md-dialog
      ...
      <md-dialog-title><svg-icon
        icon-class="pen"
        class="smb-icon" /> write</md-dialog-title>
      <div class="comment-textarea">
        ...
        <md-field :class="getValidationClass('content')">
          ...
          <span
            ...
            class="md-error">Please input comment</span>
          <span
            v-else-if="!$v.content.minLength || !$v.content.maxLength"
            class="md-error">Comment length is 6 ~ 300 characters</span>
        </md-field>
      </div>
      <md-dialog-actions>
        <md-button
          class="md-raised md-primary"
          @click="postComment">commit</md-button>
      </md-dialog-actions>
    </md-dialog>
  </div>
</template>
