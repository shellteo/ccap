              ...
              >
                ...
                >
                  <li
                    ...
                    @click="moduleActive='overview'">overview</li>
                  <li
                    :class="['topic-item', {active: moduleActive === 'stage'}]"
                    @click="moduleActive='stage'">stage</li>
                  <li
                    :class="['topic-item', {active: moduleActive === 'news'}]"
                    @click="moduleActive='news'">news</li>
                </ul>
              </s-div>
...
export default {
  ...
  computed: {
    ...
    breadcrumbs: function () {
      let arr = [{ name: 'Home', to: { name: 'services' } }, { name: 'ICO' }, { name: this.symbol }]
      return arr
    },
    coinLogo () {
